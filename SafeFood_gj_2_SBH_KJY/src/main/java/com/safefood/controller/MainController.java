...
import com.safefood.service.AllergyService;
import com.safefood.service.FoodService;
import com.safefood.service.MemberService;
import com.safefood.service.MyintakeService;
import com.safefood.service.WishService;
...
//	}
	...
	public String remove(Model model, HttpSession session, String id) {
		...
		myintakeService.deleteId(id);
		wishService.deleteId(id);
