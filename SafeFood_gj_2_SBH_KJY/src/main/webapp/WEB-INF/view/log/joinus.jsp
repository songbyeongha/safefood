...
$(function(){
    ...
    $("#doublecheck").on('click',function(){
    	$.ajax({
    		type:"get",
    		url:"./main.do?action=doublecheck",
    		data: {
    			"id" : $("#InputEmail").val()
    		},
...
<style>
	...
	<article class="container">
        ...
        <div class="col-sm-6 col-md-offset-3">
        	<c:url value="/joinus" var="joinus"></c:url>
            <form action="${joinus }" method="POST">
                <div class="form-group">
                    ...
                    <span class="btn btn-primary" id="doublecheck">
	                    	아이디 중복확인
	                </span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputName" placeholder="User Name" name="name">
                </div>
                <div class="form-group">
